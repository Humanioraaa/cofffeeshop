...
<link rel='stylesheet' href='<?php echo e(asset("assets/js/vendor/revslider/settings.css")); ?>' type='text/css' media='all' />
<link rel='stylesheet' href='<?php echo e(asset("assets/js/vendor/comp/comp.min.css")); ?>' type='text/css' media='all' />
<?php $__env->stopPush(); ?>
<?php $__env->startPush('js'); ?>
<script type='text/javascript' src='<?php echo e(asset("assets/js/vendor/esg/jquery.themepunch.tools.min.js")); ?>'></script>
<script type='text/javascript' src='<?php echo e(asset("assets/js/vendor/revslider/jquery.themepunch.revolution.min.js")); ?>'></script>
<script type="text/javascript" src="<?php echo e(asset("assets/js/vendor/revslider/extensions/revolution.extension.slideanims.min.js")); ?>"></script>
<script type="text/javascript" src="<?php echo e(asset("assets/js/vendor/revslider/extensions/revolution.extension.layeranimation.min.js")); ?>"></script>
<script type="text/javascript" src="<?php echo e(asset("assets/js/vendor/revslider/extensions/revolution.extension.navigation.min.js")); ?>"></script>
<script type="text/javascript" src="<?php echo e(asset("assets/js/vendor/revslider/extensions/revolution.extension.parallax.min.js")); ?>"></script>
<script type='text/javascript' src='<?php echo e(asset("assets/js/vendor/comp/comp_front.min.js")); ?>'></script>
<script type='text/javascript' src='<?php echo e(asset("assets/js/vendor/isotope.pkgd.min.js")); ?>'></script>
<script type='text/javascript' src='<?php echo e(asset("assets/js/vendor/jquery.hoverdir.js")); ?>'></script>
<?php $__env->stopPush(); ?>
        ...
        <div id="rev_slider_1_1" class="rev_slider fullwidthabanner" data-version="5.1">
            <ul>
                <li data-index="rs-3" data-transition="fade" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="300" data-rotate="0" data-saveperformance="off" data-title="Slide" data-description="">
                    <img src="<?php echo e(asset('assets/images/transparent.png')); ?>" alt="" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="off" class="rev-slidebg" data-no-retina>
                    ...
                    <div class="tp-caption tp-resizeme rs-parallaxlevel-2" id="slide-3-layer-5" data-x="742" data-y="62" data-width="['none','none','none','none']" data-height="['none','none','none','none']" data-transform_idle="o:1;" data-transform_in="opacity:0;s:300;e:Power2.easeInOut;" data-transform_out="opacity:0;s:300;s:300;" data-start="500" data-responsive_offset="on">
                        <img src="<?php echo e(asset('assets/images/punyang-Photoroom1-removebg-preview.png')); ?>" alt="" width="458" height="540" data-ww="458px" data-hh="540px" data-no-retina>
                    </div>
                    ...
                    <div class="tp-caption tp-resizeme" id="slide-3-layer-7" data-x="-76" data-y="518" data-width="['none','none','none','none']" data-height="['none','none','none','none']" data-transform_idle="o:1;" data-transform_in="opacity:0;s:300;e:Power2.easeInOut;" data-transform_out="opacity:0;s:300;s:300;" data-start="500" data-responsive_offset="on">
                      <img src="<?php echo e(asset('assets/images/main_slider_el_5.png')); ?>" alt="" width="391" height="216" data-ww="391px" data-hh="216px" data-no-retina>
                    </div>
                    <div class="tp-caption tp-resizeme rs-parallaxlevel-1" id="slide-3-layer-9" data-x="999" data-y="651" data-width="['none','none','none','none']" data-height="['none','none','none','none']" data-transform_idle="o:1;" data-transform_in="opacity:0;s:300;e:Power2.easeInOut;" data-transform_out="opacity:0;s:300;s:300;" data-start="500" data-responsive_offset="on">
                        <img src="<?php echo e(asset('assets/images/slider_1_el_4.png')); ?>" alt="" width="70" height="134" data-ww="70px" data-hh="134px" data-no-retina>
                    </div>
                    <div class="tp-caption tp-resizeme rs-parallaxlevel-1" id="slide-3-layer-10" data-x="545" data-y="244" data-width="['none','none','none','none']" data-height="['none','none','none','none']" data-transform_idle="o:1;" data-transform_in="opacity:0;s:300;e:Power2.easeInOut;" data-transform_out="opacity:0;s:300;s:300;" data-start="500" data-responsive_offset="on">
                        <img src="<?php echo e(asset('assets/images/main_slider_el_2.png')); ?>" alt="" width="143" height="86" data-ww="143px" data-hh="86px" data-no-retina>
                    </div>
                    <div class="tp-caption tp-resizeme" id="slide-3-layer-11" data-x="1092" data-y="561" data-width="['none','none','none','none']" data-height="['none','none','none','none']" data-transform_idle="o:1;" data-transform_in="opacity:0;s:300;e:Power2.easeInOut;" data-transform_out="opacity:0;s:300;s:300;" data-start="500" data-responsive_offset="on">
                        <img src="<?php echo e(asset('assets/images/main_slider_el_3.png')); ?>" alt="" width="169" height="131" data-ww="169px" data-hh="131px" data-no-retina>
                    </div>
                </li>
                <li data-index="rs-2" data-transition="fade" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="300" data-rotate="0" data-saveperformance="off" data-title="Slide" data-description="">
                    ...
                    <div class="tp-caption tp-resizeme rs-parallaxlevel-1" id="slide-2-layer-14" data-x="443" data-y="244" data-width="['none','none','none','none']" data-height="['none','none','none','none']" data-transform_idle="o:1;" data-transform_in="opacity:0;s:300;e:Power2.easeInOut;" data-transform_out="opacity:0;s:300;s:300;" data-start="500" data-responsive_offset="on">
                        <img src="<?php echo e(asset('assets/images/slider_2_el_2.png')); ?>" alt="" width="560" height="525" data-ww="516px" data-hh="485px" data-no-retina>
                    </div>
                    <div class="tp-caption tp-resizeme rs-parallaxlevel-1" id="slide-2-layer-12" data-x="891" data-y="275" data-width="['none','none','none','none']" data-height="['none','none','none','none']" data-transform_idle="o:1;" data-transform_in="opacity:0;s:300;e:Power2.easeInOut;" data-transform_out="opacity:0;s:300;s:300;" data-start="500" data-responsive_offset="on">
                        <img src="<?php echo e(asset('assets/images/main_slider_el_6.png')); ?>" alt="" width="72" height="140" data-ww="72px" data-hh="140px" data-no-retina>
                    </div>
                    <div class="tp-caption tp-resizeme" id="slide-2-layer-15" data-x="49" data-y="20" data-width="['none','none','none','none']" data-height="['none','none','none','none']" data-transform_idle="o:1;" data-transform_in="opacity:0;s:300;e:Power2.easeInOut;" data-transform_out="opacity:0;s:300;s:300;" data-start="500" data-responsive_offset="on">
                        <img src="<?php echo e(asset('assets/images/main_slider_el_3.png')); ?>" alt="" width="169" height="131" data-ww="152px" data-hh="118px" data-no-retina>
                    </div>
                                                ...
                                                <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <?php if($index < 9): ?>
                                                        <div class="column-1_3 column_padding_bottom">
                                                            <div id="sc_services_258_<?php echo e($index + 1); ?>" class="sc_services_item">
                                                                <div class="sc_services_item_featured post_featured">
                                                                    <div class="post_thumb" data-image="<?php echo e($product->image_path ? asset('storage/' . $product->image_path) : asset('assets/images/services_3.png')); ?>" data-title="<?php echo e($product->name); ?>">
                                                                        <a class="hover_icon hover_icon_link" href="<?php echo e(route('product.index')); ?>">
                                                                            <img alt="<?php echo e($product->name); ?>" src="<?php echo e($product->image_path ? asset('storage/' . $product->image_path) : asset('assets/images/services_3-300x281.png')); ?>">
                                                                        </a>
                                                                    </div>
                                                                </div>
                                                                <h4 class="sc_services_item_title">
                                                                    <a href="<?php echo e(route('product.index')); ?>"><?php echo e($product->name); ?></a>
                                                                </h4>
                                                            </div>
                                                        </div>
                                                    <?php endif; ?>
                                    ...
                                    <div class="wpb_revslider_element wpb_content_element">
                                        <div id="rev_slider_2_2_wrapper" class="rev_slider_wrapper fullwidthbanner-container">
                                            <div id="rev_slider_2_2" class="rev_slider fullwidthabanner" data-version="5.1">
                                                <ul>
                                                    <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $orderDetail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <li data-index="rs-<?php echo e($index + 4); ?>" data-transition="fade" data-slotamount="default"
                                                            ...
                                                            <img src="<?php echo e(asset('images/transparent.png')); ?>" alt="" data-bgposition="center center"
                                                                 data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina>

                                                            <div class="tp-caption Hotcoffee-style-7 tp-resizeme" id="slide-<?php echo e($index + 4); ?>-layer-1"
                                                            ...
                                                            <div class="tp-caption Hotcoffee-style-8 tp-resizeme" id="slide-<?php echo e($index + 4); ?>-layer-2"
                                                                 data-x="645" data-y="359" data-width="['auto']" data-height="['auto']"
                                                                 data-transform_idle="o:1;" data-transform_in="opacity:0;s:500;e:Power2.easeInOut;"
                                                                 data-transform_out="opacity:0;s:500;s:500;" data-start="500"
                                                                 data-splitin="none" data-splitout="none" data-responsive_offset="on">
                                                                <?php echo e($orderDetail->product->description ?? 'No description available'); ?>

                                                            </div>

                                                            <div class="tp-caption Hotcoffee-style-9 tp-resizeme" id="slide-<?php echo e($index + 4); ?>-layer-3"
                                                                 ...
                                                                 data-transform_out="opacity:0;s:500;s:500;" data-start="500"
                                                                 data-splitin="none" data-splitout="none" data-responsive_offset="on">
                                                                Purchased <?php echo e($orderDetail->total_qty); ?> times.
                                                            </div>

                                                            <div class="tp-caption no-style" id="slide-<?php echo e($index + 4); ?>-layer-4" data-x="654" data-y="565"
                                                            ...
                                                            <div class="tp-caption tp-resizeme" id="slide-<?php echo e($index + 4); ?>-layer-5" data-x="70" data-y="205"
                                                                ...
                                                                <img src="<?php echo e($orderDetail->product->image_path ? asset('storage/' . $orderDetail->product->path) : asset('assets/images/punyang-Photoroom1')); ?>"
                                                                     alt="<?php echo e($orderDetail->product->name); ?>" width="524" height="523" data-ww="524px" data-hh="523px" data-no-retina>
                                                            </div>
                                                            <div class="tp-caption tp-resizeme" id="slide-<?php echo e($index + 4); ?>-layer-6" data-x="649" data-y="118"
                                                                 data-width="['none','none','none','none']" data-height="['none','none','none','none']"
                                                                 data-transform_idle="o:1;" data-transform_in="opacity:0;s:500;e:Power2.easeInOut;"
                                                                 data-transform_out="opacity:0;s:500;s:500;" data-start="500"
                                                                 data-responsive_offset="on">
                                                                <img src="<?php echo e(asset('assets/images/second_slider_el_2.png')); ?>" alt="" width="202" height="104"
...
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Project\Jokian\irji\coffeeshop\resources\views/welcome.blade.php ENDPATH**/ ?>