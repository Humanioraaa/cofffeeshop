                                        ...
                                        <div class="sc_section_inner">
                                            <div class="sc_price_block sc_price_block_style_3 column-1_1">
                                                ...
                                                <div class="sc_price_block_money">
                                                    <div class="sc_price">
                                                        <span class="sc_price_currency">Rp. <?php echo e(number_format($order->total_price, 0, ',', '.')); ?></span>
                                                    </div>
                                                </div>
                                                <div class="sc_price_block_link">
                                                    <form action="<?php echo e(route('order.update', ['order' => $order->id])); ?>" method="POST">
                                                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layout.pages', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Project\Jokian\irji\coffeeshop\resources\views/order/payment.blade.php ENDPATH**/ ?>